          ...
          <div className="w-[80%] flex justify-between gap-4">
            ...
            >
              ...
              <img
                ...
                alt="Material pile"
                className="absolute -bottom-[90px] -left-[51px] max-w-[156%] h-auto transition-transform duration-300 ease-in-out group-hover:scale-110"
              />
            </Link>
            ...
            >
              ...
              <img
                ...
                alt="Material sample"
                className="absolute -bottom-[60px] -left-[90px] max-w-[156%] h-auto transition-transform duration-300 ease-in-out group-hover:scale-110"
              />
            </Link>
          </div>
        </div>
